  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20">
      <div className="flex items-end justify-between mb-10">
        ...
        <Link to="/lancamentos" className="hidden md:flex items-center gap-2 text-sm font-medium text-gold hover:text-charcoal transition-colors">
          Ver todos <ArrowRight size={16} />
        </Link>
      </div>
  ...
  const cities = [
    {
      ...
      state: 'SP',
      count: 542,
      image: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=600&q=80&fit=crop',
    },
    {
      name: 'Rio de Janeiro',
      state: 'RJ',
      ...
      <div className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 pt-20 pb-10 w-full max-w-4xl mx-auto">
          ...
          <div className="mt-6 flex items-center justify-center gap-6 animate-fade-in-up animate-delay-400">
            <Link to="/lancamentos" className="text-white/70 hover:text-white text-sm flex items-center gap-1 transition-colors">
              <Sparkles size={14} /> Ver lançamentos
            </Link>
            <span className="text-white/30">·</span>
            <Link to="/buscar" className="text-white/70 hover:text-white text-sm flex items-center gap-1 transition-colors">
