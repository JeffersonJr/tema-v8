...
const properties: Property[] = [
  ...
  },
  {
    id: '11',
    code: 'VRO-1521',
    title: 'Villa Exclusive — Jurerê Internacional',
    type: 'casa',
    purpose: 'lancamento',
    price: 6800000,
    address: {
      street: 'Av. dos Búzios, 180',
    ...
    area: 480,
    totalArea: 720,
    shortDescription: 'Residência de luxo em condomínio fechado em Jurerê Internacional. Projeto arrojado com piscina de borda infinita e vista para o mar.',
    description: 'Villa Exclusive é um empreendimento de alto padrão em Jurerê Internacional, o destino mais sofisticado do litoral catarinense. As residências foram concebidas por um renomado escritório de arquitetura português para criar residências que dialogam com a natureza sem abrir mão do luxo.\n\nCada villa tem 720m² de área total em terreno de 1.200m². A piscina de borda infinita de 18m olha diretamente para o mar, criando uma ilusão de água que se funde com o oceano.\n\nO interior combina materiais naturais — pedra, madeira, linho — com a mais avançada tecnologia de automação residencial. Seis suítes, todas com banheiras de imersão e vista para o jardim ou para o mar.',
    features: [
      'Terreno 1.200m²',
      'Piscina borda infinita 18m',
      'Vista direta para o mar',
      'Condomínio fechado 12 residências',
      'Beach club privativo',
      'Automação completa Crestron',
      'Energia solar e geotérmica',
      'Piso radiante em toda residência',
      'Academia e spa',
      'Garagem 4 veículos',
      'Entrega: Dez/2026',
    ],
  ...
  },
  {
    id: '12',
    code: 'VRO-0688',
    title: 'Apartamento Grand em Higienópolis',
    type: 'apartamento',
    purpose: 'venda',
    price: 1850000,
    address: {
      street: 'Av. Higienópolis, 742',
    ...
    parkingSpaces: 2,
    area: 168,
    shortDescription: 'Clássico paulistano restaurado com maestria. Pé-direito de 3,2m, molduras originais e cozinha contemporânea.',
    description: 'Apartamento de época em edifício icônico de Higienópolis, um dos bairros mais tradicionais de São Paulo. Restaurado com maestria, o imóvel preserva as características originais dos anos 50 — pé-direito de 3,2m, molduras em estuque, pisos em parquet de madeira nobre — enquanto incorpora uma cozinha e banheiros completamente modernizados.\n\nA sala de estar e jantar com 52m² tem janelas em arco que inundam o ambiente de luz natural. A varanda de 22m² permite vistas do arborizado bairro.\n\nTrês suítes com armários planejados, sendo a master com banheiro em mármore branco italiano e ducha de chromotherapy. A cozinha foi modernizada mantendo o espírito clássico do apartamento.',
    features: [
      'Pé-direito 3,2m',
      'Parquet madeira original restaurado',
      'Molduras em estuque originais',
      'Varanda 22m² arborizada',
      'Cozinha modernizada',
      'Banheiro master chromotherapy',
      'Banheiros em mármore italiano',
      'Portaria 24h edifício boutique',
      'Copa com vista',
      'Armários planejados personalizados',
    ],
    images: [
      'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&q=85&fit=crop',
      'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=1200&q=85&fit=crop',
  ...
  },
  {
    id: '13',
    code: 'VRO-2015',
    title: 'Mansão Contemporânea na Fazenda Boa Vista',
    type: 'casa',
    purpose: 'venda',
    price: 18500000,
    address: {
      street: 'Av. Boa Vista, Q-12',
    ...
    area: 850,
    totalArea: 1200,
    shortDescription: 'Espetacular residência integrada à natureza projetada por renomado escritório. Vista para o lago e privacidade absoluta.',
    description: 'Mansão de altíssimo padrão na cobiçada Fazenda Boa Vista, em Porto Feliz. Com arquitetura moderna e orgânica que integra perfeitamente os espaços internos ao exterior, esta propriedade oferece o máximo em privacidade e luxo no campo.\n\nA área social conta com amplas salas com pé-direito duplo, lareira ecológica, adega integrada e painéis de vidro retráteis que abrem para um deslumbrante deck com piscina de borda infinita aquecida e spa.\n\nSão 5 suítes completas com acabamentos refinados em madeira nobre e mármore, sendo a suíte master agraciada com um amplo closet e banheiro spa privativo.',
    features: [
      ...
      'Automação completa',
      'Segurança 24h especializada',
      'Energia fotovoltaica',
      'Acabamento em madeira freijó',
    ],
    images: [
  ...
  },
  {
    id: '14',
    code: 'VRO-1834',
    title: 'Villa de Luxo Contemporânea em Alphaville',
    type: 'casa',
    purpose: 'venda',
    price: 12900000,
    address: {
      street: 'Al. dos Nobres, 85',
      neighborhood: 'Tamboré 3',
    ...
    area: 720,
    totalArea: 1000,
    shortDescription: 'Residência contemporânea minimalista em condomínio fechado exclusivo. Acabamentos importados e automação.',
    description: 'Espetacular residência de luxo no Tamboré, Santana de Parnaíba. A arquitetura contemporânea e imponente destaca-se pelas linhas retas e grandes volumes de vidro.\n\nO living social com pé-direito de 6m integra salas de estar, home theater e jantar com uma cozinha gourmet de última geração. O jardim oferece uma fantástica piscina aquecida com prainha, sauna úmida e deck em madeira cumaru.\n\nNo andar superior, a ala íntima dispõe de 4 suítes espaçosas com closets dedicados e banheiros climatizados revestidos em porcelanato italiano.',
    features: [
      'Piscina aquecida com prainha',
  ...
  },
  {
    id: '15',
    code: 'VRO-3498',
    title: 'Casa de Praia Premium em Juquehy',
    type: 'casa',
    purpose: 'venda',
    price: 8200000,
    address: {
      street: 'Av. Mãe Bernarda, 1400',
      neighborhood: 'Praia de Juquehy',
      city: 'São Sebastião',
      state: 'SP',
    },
    bedrooms: 5,
    ...
    area: 450,
    totalArea: 600,
    shortDescription: 'Deslumbrante casa de praia à beira-mar com deck privativo, piscina aquecida e arquitetura praiana sofisticada.',
    description: 'Residência pé-na-areia exclusiva na badalada Praia de Juquehy, em São Sebastião. Projetada para oferecer a melhor experiência litorânea, com arquitetura rica em madeira cumaru, vidro e muita luz natural.\n\nA área externa conta com um deck panorâmico privativo que dá acesso direto à areia, equipado com piscina aquecida de borda infinita, churrasqueira gourmet e gazebo.\n\nSão 5 suítes arejadas com vista para o mar ou para a mata tropical circundante, oferecendo o equilíbrio ideal de frescor e tranquilidade.',
    features: [
      'Acesso direto à praia (pé na areia)',
      'Piscina de borda infinita frente mar',
      'Deck panorâmico em cumaru',
      'Churrasqueira gourmet',
      'Gazebo relaxante',
      'Suítes com ar-condicionado',
      'Vista mar permanente',
      'Segurança 24h em condomínio',
      'Gerador privativo',
    ],
    images: [
  ...
  },
  {
    id: '16',
    code: 'VRO-4011',
    title: 'Casa Suspensa de Design na Praia da Lagoinha',
    type: 'casa',
    purpose: 'venda',
    price: 6900000,
    address: {
      street: 'Rua das Palmeiras, S/N',
      neighborhood: 'Praia da Lagoinha',
      city: 'Ubatuba',
      state: 'SP',
    },
    bedrooms: 4,
    ...
    area: 510,
    totalArea: 800,
    shortDescription: 'Incrível arquitetura suspensa em meio à Mata Atlântica. Piscina com borda infinita e acesso a praia reservada.',
    description: 'Uma joia da arquitetura contemporânea integrada de forma espetacular com a natureza tropical de Ubatuba, na prestigiada Praia da Lagoinha. Esta casa suspensa foi concebida para flutuar entre a copa das árvores, proporcionando vistas de 180° do oceano.\n\nA estrutura conta com fechamento em painéis de vidro de alta performance, permitindo que a luz do sol e a paisagem deslumbrante entrem em cada canto do imóvel. O terraço frontal abriga uma belíssima piscina com borda infinita suspensa que parece se fundir com a linha do horizonte marítimo.',
    features: [
      'Arquitetura suspensa de design',
      'Piscina infinita suspensa',
      'Integração total com Mata Atlântica',
      'Fechamento em vidros duplos',
      'Vista panorâmica 180° do mar',
      'Acesso a praia privativa',
      'Deck em madeira reflorestada',
      'Energia limpa com placas solares',
      'Captação de água de chuva',
    ],
    images: [
      'https://images.unsplash.com/photo-1519046904884-53103b34b206?w=1200&q=85&fit=crop',
      'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&q=85&fit=crop',
    ],
    featured: true,
    isLaunch: false,
    ...
    furnished: 'sim',
    yearBuilt: 2021,
    sunPosition: 'Todos os lados/Mar',
    agent: {
      name: 'Marcelo Duarte',
      phone: '(48) 99341-7823',
      photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&q=80',
